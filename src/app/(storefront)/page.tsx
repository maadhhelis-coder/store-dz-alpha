  ...
  return (
    <>
      ...
      {/* صورة "ما يميزنا" ممتدة حافة إلى حافة (طلب صريح) — بلا إطار ذهبي وبلا أي مسافة على
          ...
          مرسومًا بداخلها فلا حاجة لعنوان قسم مكرِّر. ارتفاع صريح متدرّج (طلب صريح: مقاس
          يناسب الهاتف والحاسوب) عبر fill بدل width/height الجوهريين + h-auto — تلك التركيبة
          كانت تترك نسبة العرض للارتفاع تتحكم فالعرض الفعلي (سلوك المتصفح الافتراضي لـ
          aspect-ratio من attr()) فينكمش عرض الصورة عند تحديد سقف ارتفاع، تاركًا فراغًا
          أسود على أحد الجانبين فـRTL — دليل حقيقي شوهد فعليًا. */}
      <section className="relative w-full h-[220px] sm:h-[300px] md:h-[420px] lg:h-[520px]">
        <BrandImage
