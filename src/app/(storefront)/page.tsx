  ...
  return (
    <>
      ...
      {/* صورة "ما يميزنا" ممتدة حافة إلى حافة (طلب صريح) — بلا إطار ذهبي وبلا أي مسافة على
          ...
          مرسومًا بداخلها فلا حاجة لعنوان قسم مكرِّر. سقف ارتفاع على الشاشات الكبيرة (طلب
          صريح لاحق: كانت تكبر بلا حدود مع عرض الشاشة فتبدو "كبيرة جدًا" على الحاسوب) —
          object-cover يحافظ على الامتداد الأفقي الكامل بلا قص جانبي محسوس. */}
      <section>
        <BrandImage
          ...
          width={1536}
          height={1024}
          className="w-full h-auto max-h-[420px] md:max-h-[520px] object-cover block"
          sizes="100vw"
        />
      </section>
    </>
