  ...
  return (
    <>
      ...
      {/* طلب صريح لاحق: استبدال قسم "ما يميزنا" (كان HTML/CSS ببطاقات TRUST_BADGES) بصورة
          ...
          دون أي قصّ. طلب صريح لاحق آخر: "الصور كبار بزاف" — max-w-5xl (نفس حدّ صورة التوصيل
          أعلاه، لتناسق بصري بين الصورتين) يمنعها من التمدّد لحجم مبالغ فيه على الشاشات
          الواسعة؛ bg-black + خلفية الصفحة السوداء نفسها تجعلها تبدو بلا أي إطار جانبي مرئي
          رغم عدم بلوغها literal 100vw. */}
