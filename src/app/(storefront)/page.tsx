  ...
  return (
    <>
      ...
      {/* طلب صريح لاحق: استبدال قسم "ما يميزنا" (كان HTML/CSS ببطاقات TRUST_BADGES) بصورة
          ...
          فعليًا الآن (بلا حدّ عرض). طلب صريح لاحق آخر: "نقص فالزووم" — تصغير مرئي خفيف
          (scale(0.92)) عبر style مضمّن، بلا تغيير عرض/موضع الحاوية (نفس معاملة صورة التوصيل
          أعلاه لتناسق بصري). ملاحظة: أُزيل -mt-3 المُضاف سابقًا خطأً هنا — كان يستهدف الفراغ
          *أعلى* هذا القسم بينما طلب المستخدم يخصّ الفراغ *أسفله* (انظر Footer.tsx). */}
