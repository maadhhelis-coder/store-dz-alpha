...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    return [
      ...
      {
        // ردود API المصادَق عليها (جلسة/مفتاح) تحمل بيانات عملاء ومالية: لا تخزين مؤقت
        // في أي وسيط أو متصفح (الافتراضي كان public, max-age=0 — تحقق فعلي على الإنتاج).
        source: "/api/(admin|mcp|auth)/:path*",
